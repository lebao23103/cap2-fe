...
export function ChatWidget() {
  ...
  return (
    <>
      ...
      {(isOpen || isClosing) && (
    <div className="fixed bottom-6 right-6 z-50">
      <Card className={`w-[340px] shadow-2xl bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border border-border/40 overflow-hidden rounded-2xl origin-bottom-right transition-all duration-200 ease-out ${
