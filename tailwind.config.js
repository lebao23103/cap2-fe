  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'aurora-gradient': 'linear-gradient(135deg, #6366f1 0%, #818cf8 25%, #06b6d4 50%, #10b981 75%, #f59e0b 100%)',
        'mesh-gradient': 'linear-gradient(135deg, rgba(99, 102, 241, 0.1) 0%, rgba(67, 56, 202, 0.1) 100%)',
        ...
        'vintage-gradient': 'linear-gradient(135deg, #f1f5f9 0%, #e2e8f0 25%, #cbd5e1 50%, #94a3b8 75%, #64748b 100%)',
        'leather-texture': 'radial-gradient(ellipse at center, #4f46e5 0%, #4338ca 50%, #3730a3 100%)',
      },
      colors: {
